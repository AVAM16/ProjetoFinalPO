...
public class Network implements Serializable {
  ...
  void importFile(String filename) throws UnrecognizedEntryException, IOException, InvalidTerminalKeyException,
      UnknownClientKeyException { /* FIXME maybe other exceptions */
   ...
   * @throws InvalidTerminalKeyException   if the created terminal has an invalid
   *                                       id
   * @throws UnknownClientKeyException     if the client assigned to the terminal
   *                                       does not exist
   * @throws DuplicateTerminalKeyException
   */

  public Terminal registerTerminal(String type, String id, String clientID)
      throws InvalidTerminalKeyException, UnknownClientKeyException, DuplicateTerminalKeyException {
   ...
   * @throws UnknownClientKeyException if the terminal or the friend does not
   *                                   exist
   */
